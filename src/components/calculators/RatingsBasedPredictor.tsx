...
import { RatingsBasedPredictorProvider } from "./ratingsbasedpredictor/RatingsBasedPredictorContext";
import Inputs from "./ratingsbasedpredictor/Inputs";
import BayesianSummary from "./ratingsbasedpredictor/BayesianSummary";

const RatingsBasedPredictor: React.FunctionComponent<PanelProps> = (props) => {
  return (
    <RatingsBasedPredictorProvider>
      <Box
        sx={{
          width: "100%",
          p: 3,
...
export default RatingsBasedPredictor;
