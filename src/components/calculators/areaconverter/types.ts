...
export const AREA_UNITS: AreaUnit[] = [
  ...
  },
  {
    ...
    plural: "Guntas",
    symbol: "gunta",
    sqMetersMultiplier: 101.17141056,
    category: "regional",
    description: "Regional unit equal to 2.5 cents or 1,089 sq ft (1/40 acre)",
    formulaRelation:
      "1 gunta = 2.5 cents = 1,089 sq ft = 121 sq yd = 101.17 m²",
    isCoreUnit: false,
    accentColor: "#059669",
  },
  {
  ...
  },
  {
    ...
    plural: "Bighas",
    symbol: "bigha",
    sqMetersMultiplier: 2529.285264,
    category: "regional",
    description:
      "Traditional agricultural unit equal to 62.5 cents (27,225 sq ft)",
    formulaRelation:
      "1 bigha = 62.5 cents = 0.625 ac = 27,225 sq ft = 2,529.3 m²",
    isCoreUnit: false,
    accentColor: "#b45309",
  },
  {
  ...
  },
  {
    ...
    symbol: "cm²",
    sqMetersMultiplier: 0.0001,
    category: "metric",
    description: "Metric laboratory / paper unit (1 cm × 1 cm)",
    formulaRelation: "1 cm² = 0.0001 m² = 0.155 sq in",
    isCoreUnit: false,
    accentColor: "#0284c7",
  },
  {
    ...
    symbol: "mm²",
    sqMetersMultiplier: 0.000001,
    category: "metric",
    description: "Micro-metric engineering unit (1 mm × 1 mm)",
    formulaRelation: "1 mm² = 10⁻⁶ m² = 0.01 cm²",
    isCoreUnit: false,
    accentColor: "#475569",
  },
  {
